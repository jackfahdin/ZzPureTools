...
/** @brief 标识随 ZzAwesome 字体发布的稳定图标字形。 */
enum class ZzFontIcon : char32_t
{
    None = 0x0,
    Broom = 0xe800,
    Number00 = 0xe801,
...
/**
 * @brief 把字体图标转换为可由 Qt 字体引擎绘制的单个字符。
 * @param icon 字体图标。
 * @return None 返回空字符串，其余值返回对应 Unicode 字符。
 */
[[nodiscard]] inline QString zzFontIconText(ZzFontIcon icon)
{
    const char32_t codePoint = static_cast<char32_t>(icon);
...
Q_DECLARE_TYPEINFO(ZzFluentUI::ZzFontIcon, Q_PRIMITIVE_TYPE);
Q_DECLARE_METATYPE(ZzFluentUI::ZzFontIcon)
